...
- **Google Labs Antigravity (무료 입구)**
  - ‘말로 만드는’ 자연어 중심 에이전트 빌더(코딩 지식이 깊지 않아도 흐름 중심 시연 가능)
  - 접근 가능 여부는 계정/지역/실험 상태에 따라 달라질 수 있으니, 라이브 시작 전 접속 여부를 최소 1회 확인하고 실패 시 즉시 플랜B로 전환합니다.
  - 접속 불가 대비: 동일 시연 흐름의 스크린샷/짧은 캡처 1개를 플랜 B 자산(`85_PLAN_B_ASSETS_CHECKLIST.md`)에 맞춰 미리 준비합니다.
...
4) 렌더는 플러그인처럼 분리: **Scene은 Veo 3.1 / Shot은 Kling 2.6**
