...
**치트시트(예시)**
- KST 운영: `14:00 시작`, `17:40 엔딩`
- 영상 재생 시간(타임스탬프/챕터): `00:00 오프닝`, `12:34 WOW`, `1:02:10 Part 3`

## 3-step 빠른 운영(최소 동선)
1) 라이브 중 진행: `30_RUN_OF_SHOW_14-18.md`
2) 라이브 중 메모: **영상 재생 시간 `__:__`만** 계속 찍기 → 종료 직후 `35_TIMESTAMP_TEMPLATE.md`에 정리
...
- 링크/고정댓글/CTA 표: `20_YT_TITLE_DESC_PIN.md`
  - 고정댓글의 **업데이트 시각** `__:__`는 **KST(시계)**로,
