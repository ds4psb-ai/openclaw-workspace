...
```
┌─────────────────────────────────────────────────────────────────┐
│                    VIVID ACADEMY PIPELINE                        │
├─────────────────────────────────────────────────────────────────┤
│                                                                  │
│  [1] 아웃라이어 영상 선정                                          │
│       ↓                                                          │
│  [2] Antigravity (FFmpeg 프레임 추출)                             │
│       ↓                                                          │
│  ┌─────────────────────────────────────────────────────────┐    │
│  │ [3] BUILDER 1 (이미지 프롬프트 생성기) V7.4              │    │
│  │     - 입력: 영상 + FFmpeg 타임스탬프                     │    │
│  │     - 4-STEP: 분석 → Phase1-2 → Phase3-4 → 최종 출력    │    │
│  │     - 출력: VIDEO_PROMPTS_RAW.md                        │    │
│  │       ├─ <<<ANALYSIS>>>                                 │    │
│  │       └─ <<<IMAGE_PROMPTS>>>                            │    │
│  └─────────────────────────────────────────────────────────┘    │
│       ↓                                                          │
...
│       ↓                                                          │
│  ┌─────────────────────────────────────────────────────────┐    │
│  │ [5] BUILDER 2 (패러디 오마주 엔진) V4.0                  │    │
│  │     - 입력: 영상 + RAW.md + persona.json + 베스트 댓글   │    │
│  │     - 4-STEP: 검증 → 오마쥬 → 변주옵션 → 최종출력       │    │
│  │     - 출력 (4개 파일 다운로드):                          │    │
│  │       ├─ ohmage_image_prompts.md   ← imge.md            │    │
│  │       ├─ ohmage_motion_prompts.md  ← motion.md          │    │
│  │       ├─ variation_image_prompts.md                     │    │
│  │       └─ variation_motion_prompts.md                    │    │
│  └─────────────────────────────────────────────────────────┘    │
│       ↓                                                          │
│  [6] 이미지 생성 (NanoBanana Pro / Midjourney V7)                │
│       ↓                                                          │
│  [7] 영상 생성 (Kling 3.0 / Veo 3.1)                            │
│       ↓                                                          │
│  [8] 편집 (CapCut / Premiere)                                    │
│       ↓                                                          │
│  ✅ 최종 영상 완성                                                │
│                                                                  │
└─────────────────────────────────────────────────────────────────┘
